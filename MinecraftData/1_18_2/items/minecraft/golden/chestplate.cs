...
{
    [Item(ItemNameID.golden_chestplate)]
    public class golden_chestplate : IBaseItem, IHasCategory, IArmor
    {
        public short id => 755;
        public Rarity rarity => Rarity.common;
        public byte max_stack_size => 1;
        public short max_damage => 112;
        public bool is_fire_resistant => false;
        public string translation_key => "item.minecraft.golden_chestplate";
