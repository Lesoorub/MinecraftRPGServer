...
{
    [Item(ItemNameID.diamond_leggings)]
    public class diamond_leggings : IBaseItem, IHasCategory, IArmor
    {
        public short id => 752;
        public Rarity rarity => Rarity.common;
        public byte max_stack_size => 1;
        public short max_damage => 495;
        public bool is_fire_resistant => false;
        public string translation_key => "item.minecraft.diamond_leggings";
