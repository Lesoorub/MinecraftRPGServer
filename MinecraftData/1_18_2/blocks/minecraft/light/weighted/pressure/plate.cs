...
{
    [Block(BlockNameID.light_weighted_pressure_plate)]
    public class light_weighted_pressure_plate : IBlockData
    {
        public short DefaultStateID => 6852;
        public float Hardness => 0.5f;
        public float ExplosionResistance => 0.5f;
        public bool IsTransparent => true;
        public byte SoundGroup => 0;
        public short DroppedItem => 621;
