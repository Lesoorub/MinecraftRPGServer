...
{
    [Block(BlockNameID.light_gray_stained_glass_pane)]
    public class light_gray_stained_glass_pane : IBlockData
    {
        public short DefaultStateID => 7368;
