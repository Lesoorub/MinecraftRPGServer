...
{
    [Block(BlockNameID.magenta_stained_glass_pane)]
    public class magenta_stained_glass_pane : IBlockData
    {
        public short DefaultStateID => 7176;
